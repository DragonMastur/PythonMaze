	...
	def update(self):
		...
		if self.dem == 2:
			if self.GS.gameboard[self.postion[0]][self.postion[1]].outer != 'none':
				...
				self.GS.c_rect(self.postion[0]*self.GS.rectw, self.postion[1]*self.GS.recth, (self.postion[0]+1)*self.GS.rectw, (self.postion[1]+1)*self.GS.recth, self.poscolor, text=self.GS.gameboard[self.postion[0]][self.postion[1]].text)
		else:
